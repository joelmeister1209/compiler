...
public interface MicroListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MicroParser#factor_tail}.
	 * @param ctx the parse tree
	 */
	void enterFactor_tail(@NotNull MicroParser.Factor_tailContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#factor_tail}.
	 * @param ctx the parse tree
	 */
	void exitFactor_tail(@NotNull MicroParser.Factor_tailContext ctx);
